<?php
  ...
  // divido l'array in blocchi
  foreach ($faq as $div) {
    // scorro gli elementi di ogni blocco
    for ($i=0; $i <count($div) ; $i++) {
      // solo la domanda ,che dovrà essere in prima posizione, viene stampata
      //nel tag h1 , le risposte in un tag p
      if ($i == 0) {
        echo "<h1>".$div[$i].'</h1>';
      }else {
        echo "<p>".$div[$i].'</p>';
